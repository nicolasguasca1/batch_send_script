...
from config import txt_message_above, gmail_address, subject_line_above, scopes, credenciales, port, max_emails
    ...
    with open(args.csv_file_path, 'r') as csv_file:
        ...
        for i, row in enumerate(csv_reader):
            ...
            if len(row) == 2:
                ...
                message = create_message(message=txt_message_above, email_from=gmail_address, email_to=gmail_address, subject=subject_line_above,
